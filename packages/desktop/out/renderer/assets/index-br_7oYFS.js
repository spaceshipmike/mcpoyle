...
function hashQueryKey(queryKey) {
  return JSON.stringify(queryKey, (_2, val) => isPlainObject$2(val) ? Object.keys(val).sort().reduce((result, key) => {
    result[key] = val[key];
    return result;
  }, {}) : val);
}
...
function replaceEqualDeep(a, b, depth = 0) {
  ...
  if (array || isPlainObject$2(a) && isPlainObject$2(b)) {
    ...
    for (let i = 0; i < bSize; i++) {
      ...
      copy2[key] = replaceEqualDeep(a[key], b[key], depth + 1);
      if (copy2[key] === a[key]) {
        equalItems++;
      }
    }
...
class MutationCache extends Subscribable {
  ...
  resumePausedMutations() {
    ...
    this.resuming = ((_this$resuming = this.resuming) != null ? _this$resuming : Promise.resolve()).then(() => {
      ...
      return notifyManager.batch(() => pausedMutations.reduce((promise, mutation) => promise.then(() => mutation.continue().catch(noop$6)), Promise.resolve()));
    }).then(() => {
...
class QueryClient {
  ...
  refetchQueries(arg1, arg2, arg3) {
    ...
    let promise = Promise.all(promises).then(noop$6);
  ...
  prefetchQuery(arg1, arg2, arg3) {
    return this.fetchQuery(arg1, arg2, arg3).then(noop$6).catch(noop$6);
  }
  /**
   * @deprecated This method should be used with only one object argument.
   */
  ...
  prefetchInfiniteQuery(arg1, arg2, arg3) {
    return this.fetchInfiniteQuery(arg1, arg2, arg3).then(noop$6).catch(noop$6);
  }
  resumePausedMutations() {
...
var objectIs$1 = "function" === typeof Object.is ? Object.is : is$1, useState = React$1.useState, useEffect = React$1.useEffect, useLayoutEffect = React$1.useLayoutEffect, useDebugValue = React$1.useDebugValue;
...
function $(r) {
  const n = {
    subscribe(e) {
      let s = null, c = false, a = false, f = false;
      function C() {
        if (s === null) {
          f = true;
          return;
        }
        a || (a = true, typeof s == "function" ? s() : s && s.unsubscribe());
      }
      return s = r({
        next(u) {
          var l;
          c || (l = e.next) == null || l.call(e, u);
        },
        error(u) {
          var l;
          c || (c = true, (l = e.error) == null || l.call(e, u), C());
        },
        complete() {
          var u;
          c || (c = true, (u = e.complete) == null || u.call(e), C());
        }
      }), f && C(), {
        unsubscribe: C
      };
...
p = /* @__PURE__ */ new WeakMap(), w = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakSet(), v = function(n) {
...
function Split({
  ...
  const [ratio, setRatio] = reactExports.useState(() => {
    try {
  ...
  const resetRatio = reactExports.useCallback(() => setRatio(0.5), []);
...
function ToastProvider({ children }) {
  ...
  const toast = reactExports.useCallback((message, type = "success") => {
    const id = nextId++;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ToastContext.Provider, { value: { toast }, children: [
    children,
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-4 right-4 z-50 flex flex-col gap-1.5 pointer-events-none", children: toasts.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `
...
const MONO$4 = '"Commit Mono", "SF Mono", ui-monospace, Menlo, monospace';
...
function PanelHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 12, minWidth: 0 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
          ...
          sublabel && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              style: {
                fontSize: 11,
        ...
        right && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 12, alignItems: "center" }, children: right })
      ]
    }
  );
}
      ...
      children: tabs.map((tab) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              tab.label,
              typeof tab.count === "number" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    marginLeft: 6,
...
function ListRow({
  ...
  const num = String(index2).padStart(2, "0");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
...
function PanelScroll({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, overflowY: "auto", minHeight: 0 }, children });
}
function WireRow({
  label,
  sublabel,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      type: "button",
      onClick: interactive ? onToggle : void 0,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(WireGlyph, { wired, dim: disabled }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { flex: 1, minWidth: 0 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function LibraryPanel({ tools, error, projects, wireApi }) {
  const [view, setView] = reactExports.useState({ mode: "list" });
  const [filter, setFilter] = reactExports.useState("all");
  if (view.mode === "detail") {
    const tool = tools?.find((t) => t.id === view.toolId);
    if (!tool) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelShell, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          PanelHeader,
          {
            label: "LIBRARY",
            sublabel: "NOT FOUND",
            right: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton$1, { onClick: () => setView({ mode: "list" }) })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEmpty, { children: "TOOL NOT IN CURRENT SCAN" })
      ] });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      LibraryDetail,
...
function LibraryList({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PanelHeader, { label: "LIBRARY", sublabel: "GLOBAL" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FilterTabs,
      {
        tabs: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelScroll, { children: [
      error && /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelEmpty, { children: [
        "SCAN FAILED · ",
        error
      ] }),
      !error && tools === null && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEmpty, { children: "SCANNING…" }),
      !error && tools !== null && filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEmpty, { children: tools.length === 0 ? "NO TOOLS FOUND" : `NO ${filter.toUpperCase()}S` }),
      !error && filtered.map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ListRow,
        {
          index: i + 1,
          label: tool.name,
          sublabel: tool.detail,
          meta: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(OriginGlyph, { origin: tool.origin }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tool.type.toUpperCase() })
          ] }),
...
function LibraryDetail({
  ...
  const filteredProjects = reactExports.useMemo(
    () => (projects ?? []).filter(
      (p2) => p2.path === "__global__" || p2.registryStatus === "active"
    ),
    [projects]
  );
  const handleToggle = async (projectPath) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PanelHeader,
      {
        ...
        right: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton$1, { onClick: onBack })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelScroll, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px 32px 16px", borderBottom: "1px solid var(--hairline)" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
        ...
        tool.description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "var(--ink-2)", marginTop: 8, lineHeight: 1.5 }, children: tool.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 20, marginTop: 14, flexWrap: "wrap" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MetaItem$1, { label: "ORIGIN", value: tool.origin.toUpperCase() }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MetaItem$1, { label: "SCOPE", value: tool.scope.kind === "global" ? "GLOBAL" : "PROJECT" }),
          tool.filePath && /* @__PURE__ */ jsxRuntimeExports.jsx(MetaItem$1, { label: "PATH", value: shortPath$1(tool.filePath) })
        ] })
      ] }),
      ...
      !projects && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEmpty, { children: "LOADING PROJECTS…" }),
      filteredProjects.map((project) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            label: project.name,
            sublabel: project.path === "__global__" ? "~/.claude" : shortPath$1(project.path),
            wired,
            readOnly: !wireable,
...
function MetaItem$1({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 2, minWidth: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        style: {
...
function shortPath$1(path) {
  return path.replace(/^\/Users\/[^\/]+/, "~");
}
function ProjectsPanel({ projects, error, tools, wireMap, wireApi }) {
  const [view, setView] = reactExports.useState({ mode: "list" });
  const [filter, setFilter] = reactExports.useState("active");
  if (view.mode === "detail") {
    const project = projects?.find((p2) => p2.path === view.projectPath);
    if (!project) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelShell, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          PanelHeader,
          {
            label: "PROJECT",
            sublabel: "NOT FOUND",
            right: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { onClick: () => setView({ mode: "list" }) })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEmpty, { children: "PROJECT NOT IN CURRENT SCAN" })
      ] });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProjectDetail,
...
function ProjectList({
  ...
  const counts = reactExports.useMemo(() => {
    ...
    const real = projects.filter((p2) => p2.path !== "__global__");
    return {
      all: projects.length,
      active: 1 + real.filter((p2) => p2.registryStatus === "active").length,
      archived: real.filter((p2) => p2.registryStatus === "archived").length,
      unregistered: real.filter((p2) => p2.registryStatus === "unregistered").length
    };
  }, [projects]);
  const filtered = reactExports.useMemo(() => {
    if (!projects) return [];
    const isGlobal = (p2) => p2.path === "__global__";
    switch (filter) {
      case "all":
        return projects;
      case "active":
        return projects.filter((p2) => isGlobal(p2) || p2.registryStatus === "active");
      case "archived":
        return projects.filter((p2) => !isGlobal(p2) && p2.registryStatus === "archived");
      case "unregistered":
        return projects.filter((p2) => !isGlobal(p2) && p2.registryStatus === "unregistered");
    }
  }, [projects, filter]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PanelHeader, { label: "PROJECTS", sublabel: "CLAUDE CODE" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FilterTabs,
      {
        tabs: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelScroll, { children: [
      ...
      !error && projects === null && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEmpty, { children: "SCANNING…" }),
      !error && projects !== null && filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEmpty, { children: "NO PROJECTS MATCH THIS FILTER" }),
      !error && filtered.map((project, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ListRow,
          {
            ...
            meta: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
              isGlobal && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--sync)" }, children: "GLOBAL" }),
              !isGlobal && !project.exists && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--tape)" }, children: "MISSING" }),
              !isGlobal && project.exists && !project.isGitRepo && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ink-3)" }, children: "NO GIT" })
            ] }),
...
function ProjectDetail({
  ...
  const isGlobal = project.path === "__global__";
  const [busy, setBusy] = reactExports.useState(null);
  const [filter, setFilter] = reactExports.useState("wired");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PanelHeader,
      {
        ...
        right: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { onClick: onBack })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelScroll, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px 32px 16px", borderBottom: "1px solid var(--hairline)" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 20, marginTop: 14, flexWrap: "wrap" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MetaItem, { label: "PATH", value: isGlobal ? "~/.claude" : shortPath(project.path) }),
          ...
          !isGlobal && /* @__PURE__ */ jsxRuntimeExports.jsx(MetaItem, { label: "GIT", value: project.isGitRepo ? "YES" : "NO" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MetaItem, { label: "TOOLS", value: String(toolsHere.length) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FilterTabs,
      ...
      filteredTools.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEmpty, { children: filter === "wired" ? isGlobal ? "NO TOOLS AT USER SCOPE" : "NO TOOLS AT PROJECT SCOPE" : "NO TOOLS IN LIBRARY" }),
...
function createRootHooks(config) {
  const mutationSuccessOverride = (options) => options.originalFn();
  ...
  function useContext() {
    return React$3.useContext(Context);
  }
...
const MONO$3 = '"Commit Mono", "SF Mono", ui-monospace, Menlo, monospace';
function DoctorView() {
  const [section, setSection] = reactExports.useState("summary");
  const entriesQuery = trpc.library.entries.useQuery(void 0, { staleTime: Number.POSITIVE_INFINITY });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DoctorSidebar, { active: section, onChange: setSection, counts }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0, overflow: "auto", padding: "32px 40px" }, children: [
          section === "summary" && /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryPanel, { counts, reconcile }),
          section === "entries" && /* @__PURE__ */ jsxRuntimeExports.jsx(EntriesPanel, { entries }),
          section === "drifts" && /* @__PURE__ */ jsxRuntimeExports.jsx(DriftsPanel, { reconcile }),
          section === "orphans" && /* @__PURE__ */ jsxRuntimeExports.jsx(OrphansPanel, { reconcile }),
          section === "ignored" && /* @__PURE__ */ jsxRuntimeExports.jsx(IgnoredPanel, { reconcile })
        ] })
      ]
    }
  );
...
function SummaryPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { children: "LIBRARY HEALTH" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "ENTRIES", value: counts.entries }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "MATCHES", value: reconcile?.matches.length ?? 0 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "DRIFT", value: counts.drifts, warn: counts.drifts > 0 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "ORPHANS", value: counts.orphans, warn: counts.orphans > 0 })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 12, color: "var(--ink-2)", lineHeight: 1.6, marginTop: 12 }, children: [
      "The canonical library lives at ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { children: "~/.config/ensemble/library/" }),
      ". It is independent of Claude Code's scope system — scans reconcile against it without modifying anything until you explicitly adopt an orphan, promote a drift, or ignore an entry."
    ] })
  ] });
}
function EntriesPanel({ entries }) {
  ...
  if (entries.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState$1, { children: "NO LIBRARY ENTRIES" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: [
    ...
    grouped.map(([type, group]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(GroupHeader, { children: [
        type.toUpperCase(),
        "S · ",
        group.length
      ] }),
      group.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        EntryRow,
        {
          entry,
          ...
          onToggleLink: () => setLinkingId((cur) => cur === entry.id ? null : entry.id),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  entry.name,
                  entry.type === "plugin" && entry.pluginMarketplace && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      style: {
                        marginLeft: 8,
        ...
        linking && /* @__PURE__ */ jsxRuntimeExports.jsx(SourceLinkPicker, { entry, onDone: onLinked })
      ]
    }
  );
}
function SourceLinkPicker({ entry, onDone }) {
  const utils = trpc.useUtils();
  ...
  const [repoInput, setRepoInput] = reactExports.useState("");
  const [repoError, setRepoError] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        candidatesQuery.isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(PickerEmpty, { children: "SEARCHING…" }),
        !candidatesQuery.isLoading && registryHits.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(PickerSection, { title: "REGISTRY MATCHES", children: registryHits.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          PickerRow,
          {
            label: c.label,
          ...
          `reg-${c.source}-${c.label}`
        )) }),
        !candidatesQuery.isLoading && marketplaceHits.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(PickerSection, { title: "CONFIGURED MARKETPLACES", children: marketplaceHits.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          PickerRow,
          {
            label: c.label,
        ...
        !candidatesQuery.isLoading && registryHits.length === 0 && marketplaceHits.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(PickerEmpty, { children: "NO CANDIDATES FOUND" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PickerSection, { title: "ADD GITHUB REPO", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
          ...
          repoError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 10, color: "var(--tape)", marginTop: 6, letterSpacing: "0.08em" }, children: repoError.toUpperCase() })
        ] })
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SmallButton, { label: "USE", onClick: onApply })
      ]
    }
  );
}
...
function DriftsPanel({ reconcile }) {
  const utils = trpc.useUtils();
  ...
  if (!reconcile || reconcile.drifts.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState$1, { children: "NO DRIFT — ALL ENTRIES MATCH ON-DISK COPIES" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionTitle, { children: [
      "DRIFT · ",
      reconcile.drifts.length
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { children: "These entries exist in the library but their on-disk copies have diverged. Promote the disk version to overwrite the canonical copy, or leave as-is and the next sync will restore the library version." }),
    reconcile.drifts.map((drift) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ActionRow,
      {
      ...
      `${drift.entry.id}-${drift.reason}`
    ))
  ] });
}
function OrphansPanel({ reconcile }) {
  const utils = trpc.useUtils();
  ...
  if (!reconcile || reconcile.orphans.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState$1, { children: "NO ORPHANS — EVERY SCANNED TOOL MATCHES A LIBRARY ENTRY" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionTitle, { children: [
      "ORPHANS · ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { children: "These tools exist at some scope but have no library entry. Adopt to bring them into the canonical library, or ignore to stop being flagged on future scans." }),
    reconcile.orphans.map((orphan) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ActionRow,
      {
        ...
        action: {
          ...
          onClick: () => adoptMutation.mutate({ tool: orphan.tool }),
...
function IgnoredPanel({ reconcile }) {
  const utils = trpc.useUtils();
  ...
  if (!reconcile || reconcile.ignored.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState$1, { children: "NO IGNORED ENTRIES" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionTitle, { children: [
      "IGNORED · ",
      reconcile.ignored.length
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { children: "These tool ids have been dismissed. They exist on disk but the library will not flag them as orphans. Restore to start tracking again." }),
    reconcile.ignored.map((ig) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ActionRow,
      {
        name: ig.tool.name,
...
function Description({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--ink-2)", lineHeight: 1.6, maxWidth: 640 }, children });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        secondary && /* @__PURE__ */ jsxRuntimeExports.jsx(SmallButton, { ...secondary }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SmallButton, { ...action })
      ]
    }
  );
}
...
function EmptyState$1({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
...
const MONO$2 = '"Commit Mono", "SF Mono", ui-monospace, Menlo, monospace';
const TYPE_ORDER = ["server", "skill", "agent", "command", "style", "plugin", "hook"];
const TYPE_LABEL = {
  server: "SERVERS",
  skill: "SKILLS",
  agent: "AGENTS",
...
function MatrixView({
  ...
  const [hover, setHover] = reactExports.useState({ kind: "none" });
  const [busyCell, setBusyCell] = reactExports.useState(null);
  ...
  const columns = reactExports.useMemo(() => {
    ...
    return projects.filter((p2) => {
      if (p2.path === "__global__") return true;
      if (statusFilter === "all") return true;
      return p2.registryStatus === statusFilter;
    });
  ...
  const statusCounts = reactExports.useMemo(() => {
    ...
    for (const p2 of projects ?? []) {
      if (p2.path === "__global__") continue;
      if (p2.registryStatus === "active") c.active = (c.active ?? 0) + 1;
      else if (p2.registryStatus === "archived") c.archived = (c.archived ?? 0) + 1;
      else c.unregistered = (c.unregistered ?? 0) + 1;
    }
    return c;
  }, [projects]);
  const handleCellClick = async (tool, project) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        error && /* @__PURE__ */ jsxRuntimeExports.jsxs(MatrixEmpty, { children: [
          "SCAN FAILED · ",
          error
        ] }),
        !error && loading && /* @__PURE__ */ jsxRuntimeExports.jsx(MatrixEmpty, { children: "SCANNING…" }),
        !error && !loading && visibleTools.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(MatrixEmpty, { children: "NO TOOLS IN CURRENT FILTER" }),
        !error && !loading && visibleTools.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              flex: 1,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "table",
              {
                ...
                children: [
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                children: truncate(project.name, 14)
                              }
                            ),
                            !isGlobal && !project.exists && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 4, color: "var(--tape)", fontSize: 9 }, children: "MISSING" })
                          ]
                        },
                        project.path
                      );
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: grouped.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React$3.Fragment, { children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "td",
                              {
                                ...
                                children: [
                                  ...
                                  tool.type === "plugin" && tool.pluginMarketplace && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                    "span",
                                    {
                                      style: {
                                        marginLeft: 10,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(MatrixLegend, {})
      ]
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 2, flexWrap: "wrap" }, children: statusTabs.map((s) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 2, flexWrap: "wrap" }, children: tabs.map((t) => {
...
function MatrixLegend() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegendSwatch, { kind: "wired", label: "WIRED" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegendSwatch, { kind: "unwired", label: "UNWIRED" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegendSwatch, { kind: "hook", label: "READ-ONLY" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegendSwatch, { kind: "managed", label: "MANAGED" })
      ]
    }
  );
}
function LegendSwatch({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "inline-flex", alignItems: "center" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: swatch }),
    label
  ] });
}
function MatrixEmpty({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
...
const MONO$1 = '"Commit Mono", "SF Mono", ui-monospace, Menlo, monospace';
function SnapshotsView() {
  const snapshotsQuery = trpc.snapshots.list.useQuery(void 0, {
    staleTime: Number.POSITIVE_INFINITY
  });
  ...
  const selected = (selectedId ? snapshots.find((s) => s.id === selectedId) : null) ?? snapshots[0] ?? null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, minWidth: 0, overflow: "auto", padding: "32px 40px" }, children: selected ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          SnapshotDetail,
          {
            snapshot: selected,
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { loading: snapshotsQuery.isLoading }) }),
        confirmOpen && selected && /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "12px 20px", fontSize: 12 }, children: "Loading…" }),
        !loading && snapshots.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "12px 20px", fontSize: 12, color: "var(--graphite-dim)" }, children: "No snapshots yet." }),
        snapshots.map((s) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, opacity: 0.7 }, children: formatTimestamp(s.createdAt) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 2 }, children: s.syncContext ?? "(no context)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 11, opacity: 0.6, marginTop: 2 }, children: [
                  s.files.length,
                  " file",
                  s.files.length === 1 ? "" : "s"
                ] })
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14, marginTop: 4, wordBreak: "break-all" }, children: snapshot.id })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: restoring ? "Restoring…" : "Restore"
            }
          )
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MetaRow, { label: "Captured", value: formatTimestamp(snapshot.createdAt) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MetaRow, { label: "Context", value: snapshot.syncContext ?? "(no context)" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MetaRow, { label: "Files", value: `${snapshot.files.length}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 24 }, children: [
      ...
      expanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "ul",
        {
          ...
          children: snapshot.files.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
              style: {
                borderBottom: "1px solid var(--hairline)",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { wordBreak: "break-all", flex: 1 }, children: f.path }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
                    ...
                    children: f.state === "new-file" ? "new" : "captured"
                  }
                )
              ]
            },
...
function MetaRow({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 16, fontSize: 12, marginTop: 8 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { wordBreak: "break-all" }, children: value })
  ] });
}
function EmptyState({ loading }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "var(--graphite-dim)", padding: "20px 0" }, children: loading ? "Loading snapshots…" : "No snapshot selected. Snapshots are captured automatically before each `ensemble sync`." });
}
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 24 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
...
function AppInner() {
  const [view, setView] = reactExports.useState("patch");
  const { toast } = useToast();
  const utils = trpc.useUtils();
  const projectsQuery = trpc.projects.scan.useQuery(void 0, {
    staleTime: Number.POSITIVE_INFINITY
  });
  const libraryQuery = trpc.library.scanGlobal.useQuery(void 0, {
    staleTime: Number.POSITIVE_INFINITY
  });
  const projectPaths = reactExports.useMemo(() => {
    const scanned = projectsQuery.data ?? [];
    return scanned.filter((p2) => p2.seenIn.includes("claude-code")).map((p2) => p2.path);
  }, [projectsQuery.data]);
  ...
  reactExports.useEffect(() => {
    ...
    bootstrapMutation.mutateAsync({ projectPaths }).then(() => {
      utils.library.entries.invalidate();
      utils.library.reconcileScope.invalidate();
    }).catch(() => {
  ...
  const entriesQuery = trpc.library.entries.useQuery(void 0, {
    staleTime: Number.POSITIVE_INFINITY
  });
  const reconcileQuery = trpc.library.reconcileScope.useQuery(
    { scope: "global" },
  ...
  const libraryStatus = reactExports.useMemo(() => {
  ...
  const projects = reactExports.useMemo(() => {
    ...
    const ccOnly = projectsQuery.data.filter((p2) => p2.seenIn.includes("claude-code"));
    return [GLOBAL_PROJECT, ...ccOnly];
  }, [projectsQuery.data]);
  const globalScanTools = libraryQuery.data ?? null;
  const wireMap = wireMapQuery.data ?? {};
  const libraryTools = reactExports.useMemo(() => {
    if (!entriesQuery.data) return null;
    return entriesQuery.data.map((entry) => {
      const id = entry.type === "plugin" ? `plugin:${entry.name}@${entry.pluginMarketplace ?? entry.source}` : `${entry.type}:${entry.name}`;
      return {
        id,
        type: entry.type,
        name: entry.name,
        ...
        detail: entry.source,
        pluginEnabled: entry.type === "plugin" ? true : void 0,
        pluginMarketplace: entry.type === "plugin" ? entry.pluginMarketplace ?? (entry.source !== "@discovered" ? entry.source : void 0) : void 0
      };
    });
  }, [entriesQuery.data]);
  ...
  const isWired = reactExports.useCallback(
    (toolId, projectPath) => {
  ...
  const refreshOne = reactExports.useCallback(
    (targetPath) => {
  ...
  const wire = reactExports.useCallback(
    async (tool, targetPath) => {
      const target = targetPath === "__global__" ? { kind: "global" } : { kind: "project", path: targetPath };
      const source = tool.scope.kind === "global" ? { kind: "global" } : { kind: "project", path: tool.scope.path };
      ...
      try {
        ...
        if (res.ok) {
          toast(
            `WIRED ${tool.name.toUpperCase()} → ${targetPath === "__global__" ? "GLOBAL" : basename(targetPath)}`
          );
        } else {
  ...
  const unwire = reactExports.useCallback(
    async (tool, targetPath) => {
      const scope = targetPath === "__global__" ? { kind: "global" } : { kind: "project", path: targetPath };
      const name = tool.type === "plugin" ? tool.id.replace(/^plugin:/, "") : tool.name;
      try {
  ...
  const wireApi = { isWired, wire, unwire };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TopChrome, { view, onViewChange: setView, libraryStatus }),
        loading && /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingState, {}),
        projectsError && !projects && /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorState, { message: projectsError }),
        !loading && view === "patch" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Split,
          {
        ...
        !loading && view === "matrix" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          MatrixView,
          {
            tools: libraryTools,
            projects,
        ...
        !loading && view === "doctor" && /* @__PURE__ */ jsxRuntimeExports.jsx(DoctorView, {}),
        !loading && view === "snapshots" && /* @__PURE__ */ jsxRuntimeExports.jsx(SnapshotsView, {})
      ]
    }
  );
}
...
function TopChrome({
  ...
  const sublabel = view === "patch" ? "PATCH BAY" : view === "matrix" ? "MATRIX" : view === "doctor" ? "DOCTOR" : "SNAPSHOTS";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(LibraryStatusBadge, { status: libraryStatus })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 20 }, children: tabs.map((tab) => {
...
function LibraryStatusBadge({ status }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ink-3)" }, children: "LIB" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--graphite)" }, children: status.total }),
        status.drifts > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ink-3)" }, children: "·" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "var(--tape)" }, children: [
            status.drifts,
            " DRIFT"
          ] })
        ] }),
        status.orphans > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ink-3)" }, children: "·" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "var(--tape)" }, children: [
            status.orphans,
            " ORPHAN"
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--ink-3)" }, children: message })
      ]
    }
  );
}
...
if (root) {
  clientExports.createRoot(root).render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(trpc.Provider, { client: trpcClient, queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }) })
  );
}
//# sourceMappingURL=index-br_7oYFS.js.map
